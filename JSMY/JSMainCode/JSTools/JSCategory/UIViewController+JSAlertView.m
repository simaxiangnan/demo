//
//  UIViewController+JSAlertView.m
//  JSMY
//
...
@implementation UIViewController (JSAlertView)

#pragma mark - *****  alert view
- (void)JSAlertWithTitle:(NSString *)title
...
#pragma mark - *****  sheet
- (void)JSActionSheetWithTitle:(NSString *)title
                       message:(NSString *)message
